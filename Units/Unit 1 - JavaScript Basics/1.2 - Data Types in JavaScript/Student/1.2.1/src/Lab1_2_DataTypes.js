...
let singleQuotes = 'Learning JavaScript is fun!';
let doubleQuotes = "Strings can use double quotes too.";
...
console.log("greeting.substr(7, 3) =", greeting.substr(7, 3)); // legacy but works
